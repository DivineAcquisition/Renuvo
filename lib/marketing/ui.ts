...
export const marketingHeroTitle =
  "font-heading font-semibold text-[2.5rem] leading-[1.08] tracking-tight text-ink-950 sm:text-5xl md:text-[3.55rem] md:leading-[1.06]";

export const marketingSectionTitle =
  "font-heading font-semibold max-w-3xl text-[1.7rem] tracking-tight text-ink-950 sm:text-[2.15rem] sm:leading-tight";
...
export const marketingNavLink =
  "rounded-md px-2.5 py-1.5 text-sm font-medium text-silver transition-colors hover:text-ink-950 focus-visible:text-ink-950";
